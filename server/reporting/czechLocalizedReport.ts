...
function supportNotice(canonical: CanonicalReport): string {
  if (canonical.countryCode === 'CZ') {
    return 'Pro Česko jsou integrovány vybrané národní zdroje ČÚZK/RÚIAN a České geologické služby (ČGS). Údaje, které tato verze LandSurf automaticky nezískává, musí být ověřeny v příslušném oficiálním registru nebo u kompetentního úřadu.';
  }
