export type LogicalSourceId = 'BGS_DETAILED_GEOLOGY' | 'BGS_REGIONAL_GEOLOGY' | 'BGS_BOREHOLES' | 'BGS_HYDROGEOLOGY' | 'SOILGRIDS_MODEL' | 'PL_SMGP_DETAILED_GEOLOGY' | 'PL_MLP_LITHOGENETIC' | 'PL_MGP_REGIONAL_GEOLOGY' | 'PL_ENGINEERING_GEOLOGY' | 'PL_ENGINEERING_BOREHOLES' | 'PL_ENGINEERING_PROPERTIES' | 'PL_HYDROGEOLOGY' | 'PL_GROUNDWATER_MONITORING' | 'PL_SOPO_LANDSLIDES';
