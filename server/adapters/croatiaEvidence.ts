...
export const CROATIA_EVIDENCE_LAYERS: CroatiaEvidenceLayer[] = [
  ...
  { id: 'hr-groundwater-bodies-wfd', category: 'Hydrogeology', dataset: 'Groundwater bodies — WFD Reporting', provider: 'Hrvatske vode', serviceUrl: 'https://servisi.voda.hr/wms', serviceType: 'WMS', status: 'LIVE_VERIFIED', dueDiligenceUse: 'Official groundwater-body identity and WFD quantitative/chemical status at the selected coordinate.', limitation: 'Regional groundwater-body evidence does not provide parcel groundwater level, seasonal variation or site-specific dewatering/design parameters.' },
