...
async function handleAnalyzeSite(req: express.Request, res: express.Response) {
  ...
  try {
    ...
    const reportData = {
      ...
      titles,
      geosurvey_context: { survey_authority: canonicalReport.geology.sourceName, geological_unit_name: canonicalReport.geology.unitName, lithology_type: canonicalReport.geology.lithology, geological_period_era: canonicalReport.geology.geologicalAge, superficial_deposit: acquisitionContext.superficial_deposit, superficial_lithology: acquisitionContext.superficial_lithology, groundwater_regime: canonicalReport.geology.groundwaterRegime, seismic_hazard_zone: canonicalReport.hazards.seismic.classification, radon_class: canonicalReport.hazards.radon.classification, official_portal_url: canonicalReport.geology.sourceUrl, evidence_level: canonicalReport.geology.status, evidence_tier: acquisitionContext.evidence_tier, source_scale: acquisitionContext.source_scale, nearby_borehole_count: acquisitionContext.nearby_borehole_count, nearest_borehole_distance_km: acquisitionContext.nearest_borehole_distance_km, nearest_borehole_record_id: acquisitionContext.nearest_borehole_record_id },
