...
export const NATIONAL_GEOSURVEYS: Record<string, GeoSurveyProfile> = {
  ...
  DK: {
    ...
    description: 'Danske nationale data for jordarter, boringer, grundvandsobservationer, matrikel og vedtagne lokalplaner. GroundSurf anvender kun de lag, der er teknisk integreret og valideret i den aktuelle version.',
    datasets: [
  ...
  SE: {
    ...
    description: 'Svenska öppna geologiska och hydrogeologiska data via SGU. GroundSurf hämtar endast de nationella lager som är tekniskt integrerade och validerade i aktuell version.',
    datasets: [
  ...
  NO: {
    ...
    description: 'Norske offentlige data for grunnforhold, eiendom og naturfare via NGU, Kartverket og NVE. GroundSurf bruker bare nasjonale lag som er koblet til og kontrollert i den aktuelle versjonen.',
    datasets: [
