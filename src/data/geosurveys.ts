...
export const EUROPEAN_GEOSURVEYS: Record<string, GeoSurveyRegistry> = {
  PL: {
    countryCode: 'PL', countryName: 'Poland', authorityName: 'Państwowy Instytut Geologiczny – Państwowy Instytut Badawczy', acronym: 'PIG-PIB',
    officialPortalUrl: 'https://www.pgi.gov.pl', mapViewerUrl: 'https://geolog.pgi.gov.pl', cadastrePortalUrl: 'https://geoportal.gov.pl', hazardPortalUrl: 'https://osuwiska.pgi.gov.pl',
    description: 'PIG-PIB CBDG (Centralna Baza Danych Geologicznych) & SMGP (Szczegółowa Mapa Geologiczna Polski 1:50 000)',
    datasets: ['Szczegółowa Mapa Geologiczna Polski 1:50 000 (SMGP)', 'Centralna Baza Danych Geologicznych (CBDG) – Rejestr Otworów Wiertniczych', 'System Osłony Przeciwosuwiskowej (SOPO)', 'Mapa Hydrogeologiczna Polski 1:50 000 (MHP) – Pierwszy Poziom Wodonośny', 'Hydroportal ISOK – Mapy Zagrożenia i Ryzyka Powodziowego (Wody Polskie)', 'Krajowy Rejestr Cen Nieruchomości (RCiWN / Geoportal.gov.pl)']
  },
  DE: {
    countryCode: 'DE', countryName: 'Germany', authorityName: 'Bundesanstalt für Geowissenschaften und Rohstoffe', acronym: 'BGR / SGD',
    officialPortalUrl: 'https://www.bgr.bund.de', mapViewerUrl: 'https://geoviewer.bgr.de', cadastrePortalUrl: 'https://www.bodenrichtwerte-boris.de', hazardPortalUrl: 'https://www.geoportal.de',
    description: 'BGR Geologische Übersichtskarte 1:250 000 (GÜK250) & BORIS-D Bodenrichtwerte',
    datasets: ['BGR Geologische Übersichtskarte von Deutschland 1:250 000 (GÜK250)', 'BGR Hydrogeologische Übersichtskarte 1:250 000 (HÜK250)', 'Bodenkundliche Übersichtskarte von Deutschland 1:200 000 (BÜK200)', 'BORIS-D – Bodenrichtwertinformationssystem Deutschland', 'GDI-DE – Geodateninfrastruktur Deutschland', 'LUBW / LfU Hochwassergefahrenkarten (HQ100 / HQextrem)']
  },
  FR: {
    countryCode: 'FR', countryName: 'France', authorityName: 'Bureau de Recherches Géologiques et Minières', acronym: 'BRGM',
    officialPortalUrl: 'https://www.brgm.fr', mapViewerUrl: 'https://infoterre.brgm.fr', cadastrePortalUrl: 'https://www.cadastre.gouv.fr', hazardPortalUrl: 'https://www.georisques.gouv.fr',
  ...
  AT: {
    ...
    officialPortalUrl: 'https://www.geosphere.at', mapViewerUrl: 'https://geosphere.at/karten-und-daten', cadastrePortalUrl: 'https://www.kataster.at', hazardPortalUrl: 'https://www.hora.gv.at',
    description: 'GeoSphere Austria Geologische Karte 1:50 000 & HORA Naturgefahrenübersicht',
    datasets: ['Geologische Karte der Republik Österreich 1:50 000', 'HORA – Natural Hazard Overview & Risk Assessment', 'Baugrund- und Hydrogeologiekataster Österreich', 'DORIS / SAGIS / TIRIS Landes-Geodaten']
  },
  GB: {
  ...
  ES: {
    ...
    officialPortalUrl: 'https://www.igme.es', mapViewerUrl: 'https://info.igme.es/cartografiadigital/geologica/magna50.aspx', cadastrePortalUrl: 'https://www.sedecatastro.gob.es', hazardPortalUrl: 'https://sig.mapama.gob.es/snczi',
  ...
  IT: {
    ...
    datasets: ['CARG – Progetto di Cartografia Geologica e Geotematica 1:50 000', 'IdroGEO – Piattaforma Nazionale sul Dissesto Idrogeologico (Frane/Alluvioni)', 'Carta delle Frane d\'Italia (Progetto IFFI)', 'Agenzia delle Entrate – Osservatorio del Mercato Immobiliare (OMI)']
  },
  NL: {
    countryCode: 'NL', countryName: 'Netherlands', authorityName: 'TNO – Geologische Dienst Nederland / Basisregistratie Ondergrond', acronym: 'TNO-GDN / BRO / DINOloket',
    officialPortalUrl: 'https://www.dinoloket.nl', mapViewerUrl: 'https://www.dinoloket.nl', cadastrePortalUrl: 'https://www.pdok.nl/ogc-apis/-/article/kadastrale-kaart', hazardPortalUrl: 'https://www.atlasleefomgeving.nl/kans-op-overstroming-vanuit-zee-meer-of-rivier',
  ...
  NO: {
    ...
    description: 'Norwegian public ground, property and natural-hazard services. GeoSurvey directly queries selected Kartverket and NGU datasets while retaining NVE and municipal planning sources for official verification where not yet automated.',
  ...
  BE: {
    countryCode: 'BE', countryName: 'Belgium', authorityName: 'Geological Survey of Belgium / DOV Vlaanderen / SPW Géologie', acronym: 'GSB / DOV',
    officialPortalUrl: 'https://www.dov.vlaanderen.be', mapViewerUrl: 'https://www.dov.vlaanderen.be/portaal', cadastrePortalUrl: 'https://finances.belgium.be/fr/particuliers/habitation/cadastre', hazardPortalUrl: 'https://geoportail.wallonie.be',
