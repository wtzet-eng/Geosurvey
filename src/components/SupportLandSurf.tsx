...
export const FloatingSupportLandSurf: React.FC = () => (
  <a
    ...
    className="fixed bottom-4 left-4 z-40 inline-flex items-center justify-center gap-2 rounded-xl bg-[#496931] px-3 py-2 text-xs font-semibold text-white shadow-lg shadow-slate-950/15 transition hover:bg-[#3f5b2a] focus:outline-none focus:ring-2 focus:ring-[#496931]/40 focus:ring-offset-2 sm:bottom-5 sm:left-5 print:hidden"
  >
